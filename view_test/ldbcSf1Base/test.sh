...
python3 /tugraph-db_graph_views/view_test/view_test_create.py -f ldbcSf1Base --is_delete $is_delete
python3 /tugraph-db_graph_views/view_test/view_test_maintenance.py
python3 /tugraph-db_graph_views/view_test/view_test_opt.py -f ldbcSf1Base