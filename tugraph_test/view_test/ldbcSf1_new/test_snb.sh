...
python3 ./view_test_create.py -g ldbcSf1 -f ldbcSf1_new --is_delete $is_delete
python3 ./view_test_opt.py -g ldbcSf1 -f ldbcSf1_new
python3 ./view_test_maintenance.py -g ldbcSf1 -f ldbcSf1_new